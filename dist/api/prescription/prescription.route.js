...
import { createPrescriptionHandler, deletePrescriptionHandler, getPrescriptionHandler, updateDoseHandler, updateLogHandler, } from "./prescription.controller.js";
 ...
 *         description: Internal server error
 */
PrescriptionRouter.put("/:id/details", validateBody(prescriptionSchema.updateDetails), validateUpdateHandler, updateDoseHandler);
/**
 * @swagger
 * /prescription/{id}:
 *   delete:
