...
export async function validateUpdateHandler(req, res, next) {
    try {
        const data = req.body;
        const { id } = req.params ?? {};
        const target = await prescriptionService.getPrescriptionByID(id, null, {
            mode: "RISK",
            onlyAllowDraft: true,
        });
...
//# sourceMappingURL=prescription.middleware.js.map