...
import { getImexLogs, createImexLog, createManyImexLog, updateImexLog, deleteImexLog, getImexById, } from "./medicine-imex.controller.js";
import { verifyAccessToken } from "../../../middlewares/verifyToken.js";
import { validateBody, validateParams, validateQuery } from "../../../middlewares/validate.js";
import { createImexLogBodySchema, createManyImexLogBodySchema, getImexLogsQuerySchema, imexLogParamsSchema, updateImexLogBodySchema, } from "../../../schema/medicine-imex.schema.js";
const router = Router();
/**
 * @swagger
 * /medicine/imex:
 ...
 */
router.get("/", verifyAccessToken, validateQuery(getImexLogsQuerySchema), getImexLogs);
/**
 * @swagger
 * /medicine/imex/{id}:
 *   get:
 ...
 *         description: Server error - Lỗi máy chủ
 */
router.get("/:id", verifyAccessToken, validateParams(imexLogParamsSchema), getImexById);
/**
 * @swagger
 * /medicine/imex:
 *   post:
 ...
 *         description: Server error - Lỗi máy chủ
 */
router.post("/", verifyAccessToken, validateBody(createImexLogBodySchema), createImexLog);
/**
 * @swagger
 * /medicine/imex/many:
 *   post:
 ...
 *         description: Forbidden - Chỉ pharmacist mới được phép truy cập
 */
router.post("/many", verifyAccessToken, validateBody(createManyImexLogBodySchema), createManyImexLog);
/**
 * @swagger
 * /medicine/imex/{id}:
 *   patch:
 ...
 *         description: Server error - Lỗi máy chủ
 */
router.patch("/:id", verifyAccessToken, validateParams(imexLogParamsSchema), validateBody(updateImexLogBodySchema), updateImexLog);
/**
 * @swagger
 * /medicine/imex/{id}:
 *   delete:
 ...
 *         description: Server error - Lỗi máy chủ
 */
router.delete("/:id", verifyAccessToken, validateParams(imexLogParamsSchema), deleteImexLog);
