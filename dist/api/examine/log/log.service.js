...
class ExamineLogService {
    ...
    async submit(payload) {
        ...
        const newExamineLog = await prisma.$transaction(async (tx) => {
            ...
            const diagnoseDetails = diagnose.map((diseaseID) => ({ examineID, diseaseID }));
    ...
    async getExamineLogByID(examineID, isFull = false) {
        if (!isFull) {
    ...
    async updateExamineLog(examineID, payload) {
    ...
    // Not yet finished
    async getPrintableExamineLog(examineID) {
