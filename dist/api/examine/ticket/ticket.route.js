...
import { generateNewTicket, getCurrentTicket, getNextTicket, updateEnterTicket, viewEnterTicket, viewWaitingList, } from "./ticket.controller.js";
 ...
 *               $ref: '#/components/schemas/InternalServerError'
 */
enterTicketRouter.get("/", validateQuery(enterTicketSchema.viewList), viewWaitingList);
