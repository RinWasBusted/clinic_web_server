...
import { updateAvatar as updateAvatarService } from "./account.services.js";
...
export const registerMany = async (req, res, next) => {
    try {
        ...
        const tasks = accounts.map((a, index) => (async () => {
...
export const DeleteManyAccounts = async (req, res) => {
